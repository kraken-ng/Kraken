...
if __name__ == "__main__":
    ...
    try:
        ...
        parser.add_argument('-u', "--update", action='store', help="Update deployed webshell by another one (only for PHP+Linux)")
        parser.add_argument('-d', "--delete", action='store_true', help="Delete deployed webshell (only for PHP+Linux)")
